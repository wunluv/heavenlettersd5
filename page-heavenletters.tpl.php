...
<p>&nbsp;</p>
<p>Hey friends! We're doing our best to keep this website alive. Every contribution helps. Please consider sending us support through Paypal. Thank you</p>
<form method="post" action="https://www.paypal.com/cgi-bin/webscr">
<input type="hidden" value="_s-xclick" name="cmd">
<input type="hidden" value="SJ8QS64G238G6" name="hosted_button_id">
<input type="image" border="0" alt="PayPal - The safer, easier way to pay online!" name="submit" src="https://www.paypalobjects.com/en_US/i/btn/btn_donate_SM.gif">
